                        ...
                        style={{
                         ...
                         <View
                             ...
                             <View style={{}}>
                                ...
                                outerCircleStyle={{}}
                                >
                                    <Text style={{fontFamily:FontFamily.semi_bold,color:'white'}}>75 %</Text>
                                </ProgressCircle>
                             </View>
                             <View style={{
                                 width:"70%",
                 ...
                 <View style={{marginTop:20}}>
                     {
                         menuItems.map((item,ind)=>{
                             return(
                                    <TouchableOpacity
                                    //  onPress={()=>item?.navigate ? navigation.navigate(`${item.navigate}`) : setModal(true)}
                                    key={ind}
                                     >
                                        <View style={{flexDirection:'row',justifyContent:'space-between',alignItems:'center',width:'90%',padding:5,marginVertical:5,alignSelf:'center'}}>
                                            <View style={{flexDirection:'row',alignItems:'center'}}>
                                                ...
                                                <View>
                                                    ...
                                                    <Text style={{fontFamily:FontFamily.default,marginLeft:10}}>
                                                        {item?.sub}
                                                    </Text>
                                                </View>
                                            </View>
                                            <View style={{}}>
                                                <Icon name='right' type='antdesign' style={{alignSelf:'flex-end'}} />
                                            </View>
                                        </View>
                                    </TouchableOpacity>
                             )
